<?php
/*
* Sqlite3 driver that includes #tableInfo().
* 
* This is for use with PEAR::DB. Drop it into your
* $PEAR_ROOT/DB/ folder to use it.
*
* This patch has been submitted to the php-sqlite3 folks,
* so hopefully this won't be here for too long.
*
* - Nick 'OwlManAtt' Evans <owlmanatt@gmail.com>
*   2008-04-15
*
*/
  ...
  // {{{  string modifyLimitQuery(string $query, int $from, int $count [,mixed $params])
    ...
    function tableInfo($result, $mode = null)
    {
        if (is_string($result)) {
             ...
             */
            $query = @sqlite3_query($this->connection,
        ...
        $res = array();
        while($column = @sqlite3_fetch_array($query)) {
            ...
            $res[] = array(
                ...
                'name'  => $case_func($column['name']),
                'type'  => $case_func($column['type']),
                'len'   => null, // SQLite doesn't have column length...
                'flags' => $flags,
            );
